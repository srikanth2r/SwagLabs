...
describe('Home Page Suite', () => {
    ...
    it('User Validates the products', async () => {
       ...
       // await titlevalidations(Homepage.lablesaucelabsbackpack, "Sauce Labs Backpack");
...
/*
async function titlevalidations(element: ChainablePromiseElement<Promise<WebdriverIO.Element>>, Titletext:string) {
    browser.pause(100000)
    let Tilte= await element.getText();
    browser.pause(100000)
    console.log("Tile Actual text: " + Tilte)
    console.log("Expected Tile Actual text: " + Titletext)
   expect(Tilte).toHaveText(Titletext);
